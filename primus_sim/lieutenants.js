      ...
      case "elsa+4":          // 50% chance to set all rangers invisible for 1 complete turn
        if ( fleet[ship].accumulator <=50 ) {
          if (Math.random() < 0.5) {
            ...
            fleet[ship].invis.turnsLeft=1; // if set to 0, ship is immediately targetable because it is the one firing, with effectively no invisibility effect. set to 1 reproduces behavior as of 2016-03-13
          }
        }
        break;
